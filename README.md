...
- **速度决策与规划**（2025.04 - 2025.11）：实现基于**卡尔曼滤波**的预测轨迹后处理，基于**时空联合交互优化**的变道博弈与 cut-in 识别以及基于**贝叶斯模型**的 cut-in 识别；实现基于 **A\* 搜索**的速度决策与**多 ref 联合优化**的速度规划，最终使**舒适性泛化指标**由 **3.84 次/100km** 降至 **0.43 次/100km**，**安全接管泛化指标**由 **2.12 次/100km** 降至 **0.20 次/100km**，**变道成功率**由 **87%** 提升至 **98%**
